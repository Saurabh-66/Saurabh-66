...
### 🎮 [DOOM - 3D FPS Game Engine](https://github.com/Saurabh-66/DOOM-3D-FPS-Shooting-Game)

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![Pygame](https://img.shields.io/badge/Pygame-000000?style=flat-square)
![Stars](https://img.shields.io/github/stars/Saurabh-66/DOOM-3D-FPS-Shooting-Game?style=flat-square&color=yellow)
![Forks](https://img.shields.io/github/forks/Saurabh-66/DOOM-3D-FPS-Shooting-Game?style=flat-square&color=blue)

Raycasting-based 3D game engine built with Pygame. Currently used in robotics research labs for RL agent training and continual learning simulations.

**Highlights:**
- ✨ Pseudo-3D rendering using raycasting
- 🤖 Intelligent enemy AI with pathfinding
- 🎯 Real-time collision detection (60fps)

</td>
<td width="50%">

### 🗺️ [Pathfinding Algorithm Visualizer](https://github.com/Saurabh-66/Pathfinding-Algorithm-Visualizer)
...
![Diffusion](https://img.shields.io/badge/Diffusion-8B5CF6?style=flat-square)

End-to-end framework for generating 3D models from text prompts using Stable Diffusion and NeRF.

</td>
<td width="50%">

### 💓 Heart Rate Estimation via CV

![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE8?style=flat-square&logo=opencv&logoColor=white)
![Signal Processing](https://img.shields.io/badge/Signal_Processing-00D9FF?style=flat-square)

Real-time heart rate monitoring using remote photoplethysmography (rPPG) from video feeds.
...
Published **5 papers** in peer-reviewed journals on ML optimization and intelligent systems:

- 📄 **Expert Systems with Applications** (2024) - Novel self-adaptive multi-population optimization
- 📄 **Transportation Research Record** (2025) - ML-based parking demand prediction
- 📄 **International Journal of System Assurance** (2024) - Evolutionary algorithms for transportation
- 📄 **Computers and Electronics in Agriculture** (2023) - Dairy feed optimization
- 📄 **Soft Computing** (2022) - Quadratic approximation for transportation problems
...
- 🔗 Bitcoin/Cryptocurrency projects
- 🔓 Open-source ML tools and frameworks
- 🎓 Educational tech and algorithm visualizations
...
Taught data structures and algorithms to 1000+ students as Coding Club Coordinator!
